...
import { PARCELS, NOTIFICATIONS, REPORTS } from "../../data/demoData";
import { fetchParcel } from "../../lib/agricultureApi";
import {
  Search, Pin, Calendar, Sprout, Drop, Sun, Check,
  Activity, Bell, FileText, Download, Water,
} from "../shared/icons";
import { SubNav, Card, Badge } from "../shared/ui";
import LeafLoader from "../layout/LeafLoader";
