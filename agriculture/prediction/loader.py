...
# Dataset Folder (check data/PASTIS-R_PixelSet or data/raw/PASTIS-R_PixelSet)
DATASET = ROOT / "data" / "PASTIS-R_PixelSet"
if not DATASET.exists() and (ROOT / "data" / "raw" / "PASTIS-R_PixelSet").exists():
    DATASET = ROOT / "data" / "raw" / "PASTIS-R_PixelSet"
